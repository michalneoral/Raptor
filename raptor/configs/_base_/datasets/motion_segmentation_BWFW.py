    ...
    train=dict(
        ...
        datasets=[
            dict(
                type=dataset_type,
                ann_file=data_root +
                'motion_segmentation_coco_format/moving_objects_driving_final_bwfw_train.json',
            ...
            dict(
                type=dataset_type,
                ann_file=data_root +
                'motion_segmentation_coco_format/moving_objects_driving_clean_bwfw_train.json',
                img_prefix=data_root,
                seg_prefix=data_root + 'binary_motion_segmentation_png/',
                pipeline=train_pipeline),
            dict(
                type=dataset_type,
                ann_file=data_root +
                'motion_segmentation_coco_format/moving_objects_ft3d_clean_bwfw_train.json',
                img_prefix=data_root,
                seg_prefix=data_root + 'binary_motion_segmentation_png/',
                pipeline=train_pipeline),
            dict(
                type=dataset_type,
                ann_file=data_root +
                'motion_segmentation_coco_format/moving_objects_moonka_clean_bwfw_train.json',
                img_prefix=data_root,
                seg_prefix=data_root + 'binary_motion_segmentation_png/',
                pipeline=train_pipeline),
        ]
